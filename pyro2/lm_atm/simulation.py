...
from . import LM_atm_interface as lm_interface
import pyro2.mesh.reconstruction as reconstruction
import pyro2.mesh.boundary as bnd
import pyro2.mesh.patch as patch
import pyro2.mesh.array_indexer as ai

from pyro2.simulation_null import NullSimulation, grid_setup, bc_setup
import pyro2.multigrid.variable_coeff_MG as vcMG
...
class Simulation(NullSimulation):
    ...
    def initialize(self):
        ...
        problem = importlib.import_module("pyro2.lm_atm.problems.{}".format(self.problem_name))
