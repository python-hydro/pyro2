...
import importlib
import pyro2.advection_rk as advection_rk
from . import fluxes as flx
import pyro2.mesh.array_indexer as ai
import pyro2.mesh.fv as fv
from pyro2.simulation_null import grid_setup, bc_setup
...
class Simulation(advection_rk.Simulation):
    ...
    def initialize(self):
        ...
        problem = importlib.import_module("pyro2.advection_fv4.problems.{}".format(self.problem_name))
