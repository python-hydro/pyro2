...
from . import advective_fluxes as flx
...
import pyro2.util.plot_tools as plot_tools
...
class Simulation(NullSimulation):
    ...
    def initialize(self):
        ...
        problem = importlib.import_module("pyro2.advection_nonuniform.problems.{}".format(self.problem_name))
