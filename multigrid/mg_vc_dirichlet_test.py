...
pylab.savefig("mg_vc_dirichlet_test.png")
pylab.savefig("mg_vc_dirichlet_test.eps", bbox_inches="tight")
...
pylab.savefig("mg_vc_dirichlet_converge.png")
pylab.savefig("mg_vc_dirichlet_converge.eps", bbox_inches="tight")
